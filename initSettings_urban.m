function settings = initSettings()
    ...
    %% Skymask settings for urban environment
    settings.useSkymask = 1; % 1 - 启用skymask, 0 - 禁用skymask
    settings.skymaskFile = 'Task2/skymask_A1_urban.csv'; % skymask文件路径

    % 地面真值位置（用于计算方位角和仰角）
    settings.groundTruth.lat = 22.3198722; % 度
    settings.groundTruth.lon = 114.209101777778; % 度
    settings.groundTruth.alt = 3.0; % 米
